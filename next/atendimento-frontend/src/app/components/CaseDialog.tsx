        ...
        <Portal>
          ...
          <Dialog.Positioner>
            <Dialog.Content>
              ...
              <Dialog.Body>
                <p>
                  Details: {props.caseContext.label}
                </p>
                <p>
                  Details: {props.caseContext.value}
                </p>
                <p>
                  Details: {props.caseContext.diff}
                </p>
              </Dialog.Body>
              <Dialog.Footer>
      ...
      <Dialog.Root>
        ...
        <Portal>
          ...
          <Dialog.Positioner>
            <Dialog.Content>
              <Dialog.Header>
                <Dialog.Title>{props.action} Case {props.caseContext.label}</Dialog.Title>
              </Dialog.Header>
              <Dialog.Body>
                <p>
                  Details: {props.caseContext.label}
